...
public class Level2_ScriptChanges : MonoBehaviour
{
    ...
    private string manText = "Wireshark is a program that lets you look at the information in packets." + ///define argument
            "\n\nCommon Commands:" +
            "\n-Using '-k' shows where the packet is going." +
            "\n-Using '-w -' displays the information from the packet in the terminal." +
            "\n\nnmap scans IP addresses, sends and receives packets." +
            "\n\nCommon Commands:" +
